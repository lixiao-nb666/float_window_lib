package com.newbee.floatwindowlibrary.view.circlemenu.control;


import com.newbee.floatwindowlibrary.view.circlemenu.model.CircleMenuStatus;
import com.newbee.floatwindowlibrary.view.circlemenu.view.CircleMenu;
...
public class FlingEngine implements Runnable {
	...
	public void run() {
		...
		// 顺时针
		if (mCircleMenu.getmDirection() == CircleMenu.RotateDirection.CLOCKWISE) {

			flingSlowDownByClockwise();
		} else if (mCircleMenu.getmDirection() == CircleMenu.RotateDirection.ANTICLOCKWISE) {
